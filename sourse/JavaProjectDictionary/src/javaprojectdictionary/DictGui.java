...
public  class DictGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btWriteFile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaprojectdictionary/icon/write.gif"))); // NOI18N
        ...
        btFormFile.setForeground(new java.awt.Color(51, 102, 255));
        btFormFile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaprojectdictionary/icon/file.gif"))); // NOI18N
        btFormFile.setText("Mở Tệp");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btFormFile, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
    ...
    private void btFormFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btFormFileActionPerformed
        ...
        if (action == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                rcf = new ReadChooseFile(file.getPath());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(DictGui.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {

                hs = rcf.readChoose(rf.tm.keySet());
            ...
            if (hs.isEmpty()) {
                tpRead.setText("Không Có Từ vay Mượn Trong File");
            } else {
                String strOut = "\nCác Từ Vay Mượn\n\n";

                int i = 1;
                for (String s : hs) {
                    MyWord word = (MyWord) rf.tm.get(s);
                    strOut = strOut + i + ". " + word.getWord() + ":  " + word.getRead() + "\n";
                    i++;
                    System.out.println("Cac tu vay muon " + s);
                }

                tpRead.setText(strOut);
            }
        }
